	...
	return (
		<>
			<article className="hidden sm:flex flex-col sm:items-center mb-4 sm:mb-0">
				...
				<p className="mb-4">I like to make complex interactions look and feel simple.</p>
			...
			<article className="hidden sm:flex flex-col sm:items-center mb-4 sm:mb-0">
				...
				<p className="mb-4">I like to dream up database schemas and improve performance.</p>
				<h4 className="text-blue-700 mb-2">Languages I speak:</h4>
