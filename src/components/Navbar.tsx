...
export default function About() {
  ...
  return (
        ...
        <div className="px-2 relative sm:max-w-[1000px] mx-auto flex justify-between items-center gap-4 h-full w-full">
          ...
          <div className="font-bold text-xl hidden sm:relative sm:flex gap-4">
